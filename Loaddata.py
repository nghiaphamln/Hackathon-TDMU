...
pb_GDP = [(list_GDP[0], list_GDP[1], list_GDP[3])]
pb_Urate = [(list_Urate[0], list_Urate[1], list_Urate[3])]
print("\n--------------Độ tương quan---------------\n")
...
my_pal = ["MediumSpringGreen"]
sns.set_palette(my_pal)
plt.title('BIỂU ĐỒ HỘP RÂU GPD')
sns.boxplot(data=pb_GDP)
plt.xlabel("GDP")
plt.ylabel("(Tỉ USD)")
plt.show()
...
my_pal = ["crimson"]
sns.set_palette(my_pal)
plt.title('BIỂU ĐỒ HỘP RÂU TỈ LỆ THẤT NGHIỆP')
sns.boxplot(data=pb_GDP)
